...
# Пользовательский мутатор

Для учёта бинарного формата протокола n2n был реализован пользовательский мутатор AFLNet.

Исходный код находится в `mutator/n2n_mutator.c`. Мутатор компилируется как разделяемая библиотека:
